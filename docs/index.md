# go-ruby-addressable documentation

**Pure-Go (CGO=0) MRI-faithful Ruby addressable**

`go-ruby-addressable/addressable` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `addressable`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-addressable/addressable`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `addressable`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-addressable/addressable
```
...
| Repo | What it is |
| --- | --- |
| [`addressable`](https://github.com/go-ruby-addressable/addressable) | the library — Ruby's `addressable` in pure Go |
| [`docs`](https://github.com/go-ruby-addressable/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-addressable.github.io`](https://github.com/go-ruby-addressable/go-ruby-addressable.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-addressable/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-addressable/addressable](https://github.com/go-ruby-addressable/addressable).
