...
The public API lives at the module root (`github.com/go-ruby-addressable/addressable`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `addressable`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-addressable/addressable](https://pkg.go.dev/github.com/go-ruby-addressable/addressable)**

The module's [README](https://github.com/go-ruby-addressable/addressable#readme) carries worked
